...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/promotions`, lastModified: RESOURCE_UPDATED, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE_URL}/grant`, lastModified: CORE_UPDATED, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE_URL}/ada-compliance-florida`, lastModified: SERVICE_UPDATED, changeFrequency: "monthly", priority: 0.7 },
