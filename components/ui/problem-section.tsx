    ...
    <section className="relative overflow-hidden" id="problems" data-testid="problem-section">
      <div className="band-dark relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="py-12 lg:py-16 lg:w-1/2">
            <div className="max-w-xl">
              ...
              <h2 className="font-display font-black text-3xl sm:text-4xl lg:text-[2.75rem] leading-[1.1] uppercase text-white mb-4">
                MARKETING SHOULD<br />
                <span className="text-red-400">MAKE YOU MONEY,</span> NOT WASTE IT
              </h2>
              ...
              <div className="space-y-3">
                {painPoints.map((point, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="flex items-center gap-3 bg-charcoal-800 border-2 border-charcoal-700 px-4 py-3"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:flex lg:items-center lg:gap-12">
            <div className="text-center lg:text-left lg:flex-shrink-0 mb-8 lg:mb-0">
              ...
              <p className="text-editorial-lg text-charcoal-700 mb-6 lg:mb-4">
                We can help you get there.
              </p>
              <Link href="/request-quote" className="hidden lg:inline-block">
                <Button
                  variant="secondary"
                  size="xl"
            ...
            <div className="grid grid-cols-3 gap-4 lg:gap-6">
              ...
              <div className="bento-card p-6 text-center bg-white">
                ...
                <p className="label-industrial text-stone-500 text-xs">Star Rating</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-8 lg:hidden">
            <Link href="/request-quote">
              <Button
                variant="secondary"
                size="xl"
                data-testid="button-problem-cta-mobile"
              >
                GET YOUR FREE QUOTE
                <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
