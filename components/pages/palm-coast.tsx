  ...
  const services = [
    {
      ...
      description: "Custom websites built for Palm Coast businesses. Responsive, fast, and optimized to convert visitors into customers.",
      href: "/website-design"
    },
    {
      icon: <Search className="w-8 h-8 text-charcoal-900" />,
      title: "SEO Services",
      description: "Rank higher in Palm Coast search results. Local SEO, Google Maps optimization, and organic traffic growth for your business.",
      href: "/seo-services"
    },
    {
      icon: <MessageSquare className="w-8 h-8 text-charcoal-900" />,
      title: "StoryBrand Messaging",
      description: "Clarify your message so Palm Coast customers instantly understand what you offer. StoryBrand Certified agency.",
      href: "/storybrand-messaging"
    },
    {
      icon: <Palette className="w-8 h-8 text-charcoal-900" />,
      title: "Branding & Logos",
      description: "Stand out in the Palm Coast market with professional brand identity, logo design, and visual strategy.",
      href: "/branding-logos"
    },
    {
      icon: <Video className="w-8 h-8 text-charcoal-900" />,
      title: "Video Production",
      description: "Professional video production for Palm Coast businesses. Brand stories, testimonials, and promotional content filmed in Northeast Florida.",
    ...
    },
    {
      ...
      title: "HubSpot CRM",
      description: "HubSpot Platinum Partner delivering CRM implementation, marketing automation, and sales enablement for Palm Coast businesses.",
      href: "/hubspot-implementation"
    },
    {
      icon: <Smartphone className="w-8 h-8 text-charcoal-900" />,
      title: "App Development",
      description: "Custom web and mobile applications for Palm Coast companies looking to streamline operations and engage customers.",
    ...
    <div className="min-h-screen bg-stone-50 text-charcoal-900">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden min-h-[100vh] flex items-center band-dark">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <Breadcrumbs items={[{ label: "Palm Coast" }]} />
          <div className="max-w-4xl mx-auto text-center">
            <span className="label-industrial text-yellow-400 border-2 border-yellow-400 px-4 py-2 inline-block mb-6">
              SERVING PALM COAST SINCE 1999
            </span>
            <h1 className="headline-xl text-white mb-8">
              Palm Coast's Go-To<br />
              <span className="text-yellow-400">Marketing Agency</span>
            </h1>
            <p className="text-editorial-lg text-stone-400 mb-8 max-w-3xl mx-auto">
              Business Builders delivers full-service marketing to Palm Coast businesses from our nearby St. Augustine headquarters -- just 30 miles north on I-95. Website design, SEO, branding, and digital marketing that drives measurable growth.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 font-serif text-lg text-stone-600 leading-relaxed">
                <p>
                  Palm Coast is one of the fastest-growing cities in Florida, with a booming economy fueled by new businesses, retirees, and families moving to the area. With that growth comes <strong className="text-charcoal-900">increased competition for local customers</strong>.
                </p>
                <p>
                  Business Builders has served Palm Coast and Flagler County clients since 1999 from our office in St. Augustine, just 30 miles north on I-95. We understand the local market dynamics, the seasonal tourism patterns, and what it takes for businesses to thrive in this growing community.
                </p>
                <p>
                  As a <strong className="text-charcoal-900">HubSpot Platinum Partner</strong> and <strong className="text-charcoal-900">StoryBrand Certified Agency</strong>, we bring enterprise-level marketing strategy and tools to Palm Coast businesses of all sizes.
                </p>
              </div>
              <div className="mt-8 flex items-start gap-3">
                <Building className="w-6 h-6 text-yellow-500 flex-shrink-0 mt-1" />
                <div>
                  <p className="font-display font-bold text-charcoal-900">Just 30 Minutes from Palm Coast</p>
            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  text: "Unlike remote agencies, we're nearby. Meet us at your office, ours, or anywhere in between. We regularly meet clients in Palm Coast."
                },
                {
                  icon: <CheckCircle className="w-6 h-6 text-yellow-500 flex-shrink-0" />,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="headline-lg text-charcoal-900 mb-6">
              ...
              <span className="text-yellow-500">PALM COAST BUSINESSES</span>
            </h2>
            <p className="text-editorial-lg text-stone-600 max-w-3xl mx-auto">
              From web design to SEO to full-service digital marketing, we provide everything Palm Coast businesses need to dominate their market.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="headline-lg text-white mb-6">
              PALM COAST INDUSTRIES<br />
              <span className="text-yellow-400">WE SERVE</span>
            </h2>
            <p className="text-editorial-lg text-stone-400 max-w-3xl mx-auto">
              We've helped businesses across Palm Coast's growing economy build their online presence and revenue.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Home builders, contractors, and home services companies throughout Flagler County and Palm Coast."
              },
              {
                title: "Healthcare & Medical",
                description: "Medical practices, dental offices, and healthcare providers looking to attract more patients in the Palm Coast area."
              },
              {
                title: "Real Estate & Development",
                description: "Real estate agencies, property developers, and builders in the booming Palm Coast housing market."
              },
              {
                title: "Professional Services",
                description: "Law firms, financial advisors, and consultants serving the Palm Coast and Flagler County area."
              },
              {
                title: "Restaurants & Hospitality",
                description: "Hotels, restaurants, and tourism businesses in Palm Coast, Flagler Beach, and the surrounding area."
              },
              {
                title: "Nonprofits & Ministries",
                description: "Churches, ministries, and nonprofits across Palm Coast and beyond. We're passionate about mission-driven organizations."
              }
            ].map((industry, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="headline-md text-charcoal-900 mb-6">
              SERVING THE <span className="text-yellow-500">GREATER PALM COAST AREA</span>
            </h2>
            <p className="text-editorial-lg text-stone-600 max-w-3xl mx-auto">
              We serve businesses throughout the Palm Coast area, Flagler County, and all of Northeast Florida.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              "Palm Coast", "Flagler Beach", "Bunnell", "Hammock",
              "Beverly Beach", "Marineland", "Ormond Beach", "Daytona Beach",
              "St. Augustine", "Hastings", "Crescent City", "Palatka",
              "Palm Harbor", "European Village", "Town Center", "Grand Haven"
            ].map((area, index) => (
      ...
      <section className="py-20 band-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="headline-lg text-white mb-6">
            ...
            <span className="text-yellow-400">Palm Coast Business?</span>
          </h2>
          <p className="text-editorial-lg text-stone-400 mb-12 max-w-3xl mx-auto">
            Schedule a free 15-minute discovery call. We'll discuss your goals, review your current marketing, and show you exactly how we can help your Palm Coast business grow.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/request-quote">
              <Button size="xl">
