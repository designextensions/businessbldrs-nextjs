...
export default function PonteVedra() {
  const services = [
    {
      ...
      description: "Custom websites built for Ponte Vedra Beach businesses. Responsive, fast, and optimized to convert visitors into customers.",
      href: "/website-design"
    },
    {
      icon: <Search className="w-8 h-8 text-charcoal-900" />,
      title: "SEO Services",
      description: "Rank higher in Ponte Vedra search results. Local SEO, Google Maps optimization, and organic traffic growth for your business.",
      href: "/seo-services"
    },
    {
      icon: <MessageSquare className="w-8 h-8 text-charcoal-900" />,
      title: "StoryBrand Messaging",
      description: "Clarify your message so Ponte Vedra customers instantly understand what you offer. StoryBrand Certified agency.",
      href: "/storybrand-messaging"
    },
    {
      icon: <Palette className="w-8 h-8 text-charcoal-900" />,
      title: "Branding & Logos",
      description: "Stand out in the upscale Ponte Vedra market with professional brand identity, logo design, and visual strategy.",
      href: "/branding-logos"
    },
    {
      icon: <Video className="w-8 h-8 text-charcoal-900" />,
      title: "Video Production",
      description: "Professional video production for Ponte Vedra businesses. Brand stories, testimonials, and promotional content filmed in Northeast Florida.",
    ...
    },
    {
      ...
      title: "HubSpot CRM",
      description: "HubSpot Platinum Partner delivering CRM implementation, marketing automation, and sales enablement for Ponte Vedra businesses.",
      href: "/hubspot-implementation"
    },
    {
      icon: <Smartphone className="w-8 h-8 text-charcoal-900" />,
      title: "App Development",
      description: "Custom web and mobile applications for Ponte Vedra companies looking to streamline operations and engage customers.",
  ...
  const localBusinessJsonLd = {
    ...
    "priceRange": "$$",
    "description": "Ponte Vedra Beach marketing agency providing website design, SEO, branding, and digital marketing services. Based in St. Augustine, serving Ponte Vedra and St. Johns County since 1999.",
    "address": {
      "@type": "PostalAddress",
  ...
  const structuredData = {
    ...
    "@graph": [
      localBusinessJsonLd,
      getBreadcrumbSchema("Ponte Vedra Beach", "/ponte-vedra"),
      {
        "@type": "WebPage",
        "name": "Ponte Vedra Beach Marketing Agency | Business Builders",
        "description": "Business Builders is a full-service marketing agency serving Ponte Vedra Beach, FL. Website design, SEO, branding, video production, and digital marketing from nearby St. Augustine.",
        "url": "https://businessbldrs.com/ponte-vedra"
      }
    ]
  };
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-charcoal-900">
      <SEOHead
        ...
        keywords="ponte vedra beach marketing agency, ponte vedra web design, ponte vedra seo, marketing company ponte vedra fl, ponte vedra digital marketing, web designer ponte vedra, ponte vedra advertising agency, marketing agency near me ponte vedra"
        canonicalUrl={`${BASE_URL}/ponte-vedra`}
      ...
      <section className="relative pt-32 pb-20 overflow-hidden min-h-[100vh] flex items-center band-dark">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <Breadcrumbs items={[{ label: "Ponte Vedra Beach" }]} />
          <div className="max-w-4xl mx-auto text-center">
            <span className="label-industrial text-yellow-400 border-2 border-yellow-400 px-4 py-2 inline-block mb-6">
              SERVING PONTE VEDRA SINCE 1999
            </span>
            <h1 className="headline-xl text-white mb-8">
              Ponte Vedra Beach's Trusted<br />
              <span className="text-yellow-400">Marketing Agency</span>
            </h1>
            <p className="text-editorial-lg text-stone-400 mb-8 max-w-3xl mx-auto">
              Business Builders delivers full-service marketing to Ponte Vedra Beach businesses from our nearby St. Augustine headquarters. Website design, SEO, branding, and digital marketing crafted for the discerning Ponte Vedra market.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 font-serif text-lg text-stone-600 leading-relaxed">
                <p>
                  Ponte Vedra Beach is one of Northeast Florida's most prestigious communities, home to TPC Sawgrass, world-class resorts, and affluent professionals. Your marketing needs to <strong className="text-charcoal-900">match the caliber of your market</strong>.
                </p>
                <p>
                  Business Builders has served Ponte Vedra and St. Johns County clients since 1999 from our office in St. Augustine. We understand the high expectations of the Ponte Vedra market and deliver marketing that reflects the quality your brand demands.
                </p>
                <p>
                  As a <strong className="text-charcoal-900">HubSpot Platinum Partner</strong> and <strong className="text-charcoal-900">StoryBrand Certified Agency</strong>, we bring enterprise-level marketing strategy and tools to Ponte Vedra businesses -- from professional practices to luxury brands to growing startups in Nocatee.
                </p>
              </div>
              <div className="mt-8 flex items-start gap-3">
                <Building className="w-6 h-6 text-yellow-500 flex-shrink-0 mt-1" />
                <div>
                  <p className="font-display font-bold text-charcoal-900">Your Neighbors in St. Johns County</p>
              ...
              {[
                {
                  ...
                  text: "We understand the Ponte Vedra market demands excellence. Our designs and strategies reflect the sophistication your brand requires."
                },
                {
                  icon: <CheckCircle className="w-6 h-6 text-yellow-500 flex-shrink-0" />,
                  title: "Local & Accessible",
                  text: "We're right here in St. Johns County. Meet us at your office, ours, or over coffee in Ponte Vedra. We're your neighbors."
                },
                {
                  icon: <CheckCircle className="w-6 h-6 text-yellow-500 flex-shrink-0" />,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="headline-lg text-charcoal-900 mb-6">
              ...
              <span className="text-yellow-500">PONTE VEDRA BUSINESSES</span>
            </h2>
            <p className="text-editorial-lg text-stone-600 max-w-3xl mx-auto">
              From web design to SEO to full-service digital marketing, we provide everything Ponte Vedra Beach businesses need to dominate their market.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="headline-lg text-white mb-6">
              PONTE VEDRA INDUSTRIES<br />
              <span className="text-yellow-400">WE SERVE</span>
            </h2>
            <p className="text-editorial-lg text-stone-400 max-w-3xl mx-auto">
              We've helped businesses across Ponte Vedra's upscale economy grow their online presence and revenue.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Real estate agencies, luxury home builders, and property developers in the prestigious Ponte Vedra Beach market."
              },
              {
                title: "Healthcare & Wellness",
                description: "Medical practices, dental offices, wellness centers, and specialty healthcare providers in Ponte Vedra."
              },
              {
                title: "Professional Services",
                description: "Law firms, financial advisors, wealth management firms, and consultants serving the Ponte Vedra community."
              },
              {
                title: "Hospitality & Golf",
                description: "Resorts, country clubs, restaurants, and hospitality businesses in the Ponte Vedra and TPC Sawgrass area."
              },
              {
                title: "Retail & E-Commerce",
                description: "Boutique retailers, specialty shops, and e-commerce businesses serving the affluent Ponte Vedra market."
              },
              {
                title: "Nonprofits & Community",
                description: "Community organizations, foundations, and nonprofits making a difference in Ponte Vedra and St. Johns County."
              }
            ].map((industry, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="headline-md text-charcoal-900 mb-6">
              SERVING THE <span className="text-yellow-500">PONTE VEDRA AREA</span>
            </h2>
            <p className="text-editorial-lg text-stone-600 max-w-3xl mx-auto">
              We serve businesses throughout Ponte Vedra Beach, Nocatee, and all of St. Johns County.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              "Ponte Vedra Beach", "Ponte Vedra", "Nocatee", "Sawgrass",
              "Jacksonville Beach", "Neptune Beach", "Atlantic Beach", "Palm Valley",
              "St. Augustine", "World Golf Village", "Fruit Cove", "Mandarin",
              "San Marco", "Riverside", "Southside", "Town Center"
            ].map((area, index) => (
      ...
      <section className="py-20 band-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="headline-lg text-white mb-6">
            ...
            <span className="text-yellow-400">Ponte Vedra Business?</span>
          </h2>
          <p className="text-editorial-lg text-stone-400 mb-12 max-w-3xl mx-auto">
            Schedule a free 15-minute discovery call. We'll discuss your goals, review your current marketing, and show you exactly how we can help your Ponte Vedra business grow.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/request-quote">
              <Button size="xl">
